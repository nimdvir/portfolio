...
!function (b, t) {
    try {
        var W = function b(t) {
                ...
                if (W && t && "String" === n(t)) {
                    var c, m = _createForOfIteratorHelper(t.split(",")), u;
                    try {
                        for (m.s(); !(u = m.n()).done;) {
                            var a = u.value;
                ...
                var W = "test".constructor, c = [].constructor, m = {}.constructor;
                ...
                var W = _createForOfIteratorHelper(t), c;
                try {
                    for (W.s(); !(c = W.n()).done;) {
                        var m = c.value;
                        if ("childList" === m.type) {
                            var u = _createForOfIteratorHelper(m.addedNodes), n;
                            try {
                                for (u.s(); !(n = u.n()).done;) {
                                    var a = n.value;
                ...
                null !== t && (v(t, "button", W), v(t, "input", W), t.eid = W, t.addEventListener("submit", i, {capture: !0}))
            }, v = function b(t, W, c) {
                for (var m = t.getElementsByTagName(W), u = 0; u < m.length; u++) {
                    var n = m[u];
                    n && n.getAttribute("type") === B && (n.eid = c, n.addEventListener("click", i, {capture: !0}))
                }
            }, i = function b(t) {
                ...
                var c = (new TextEncoder).encode(t), m = (window.crypto || window.msCrypto).subtle.digest("SHA-256", c);
                if (window.Promise && m instanceof window.Promise) m.then(X).then(W); else if (window.CryptoOperation && m instanceof window.CryptoOperation) return W(X(m.result))
            }, f = function b(t, W, c) {
                var m, u;
            ...
            }, H = "eflp", g = "deit", R = "https:", B = "submit",
            U = /^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/,
            S = "ZW1haWw=", x = "RUl2QU54VNERVSF", k = 17, M = 5,
